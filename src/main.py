...
from src.get_data import load_data, load_diy_data
...
def main(args):
    ...
    df = load_diy_data('/home/ubuntu2010/바탕화면/famafrench_data/stockdata/30stocks_2000',
                    initial_date=args.initial_date,
                    final_date=args.final_date,
                    tickers_subset=args.assets_to_trade,
                    mode=args.mode)

    if args.mode == 'test' and args.test_start is not None and args.test_end is not None:
...
if __name__=='__main__':
    ...
    group1.add_argument('--initial_portfolio', type=str,   default='./portfolios_and_tickers/diy_portfolio.json', help='Path to json file containing the content of an initial portfolio, including the cash in bank')
    
    parser.add_argument('--assets_to_trade',   type=str,   default='./portfolios_and_tickers/ticker_diy.txt',     help='List of the tickers of the assets to be traded')
    ...
    parser.add_argument('--initial_date',      type=str,   default='2000-01-03', help="Initial date of the multidimensional time series of the assets price: str, larger or equal to '2019-07-03'")
    parser.add_argument('--final_date',        type=str,   default='2021-12-31', help="Final date of the multidimensional time series of the assets price: str, smaller or equal to '2020-12-30'")
    
    parser.add_argument('--test_start',      type=str,   default='2000-01-03', help="Initial date of the multidimensional time series of the assets price: str, larger or equal to '2019-07-03'")
    parser.add_argument('--test_end',        type=str,   default='2021-12-31', help="Final date of the multidimensional time series of the assets price: str, smaller or equal to '2020-12-30'")
